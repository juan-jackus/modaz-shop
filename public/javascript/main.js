...
(function ($) {
  ...
  var googleMap = function () {
    ...
    if ($().gmap3) {
      var data = JSON.parse(
        '[{"address":"515 Crescent St, Brooklyn, NY 11208","content":""}]'
      );
      $('.flat-map').gmap3({
        map: {
          options: {
                ...
                mouseover: function () {
                  $(this).gmap3({
                    overlay: {
                      ...
                      options: {
                        content:
                          "<div class='infobox'><p>203, Envato Labs, Behind Alis Steet</p><div class='clearfix'></div></div>",
                        offset: {
                          y: 32,
                          x: -19,
                        },
  ...
  var responsiveMenu = function () {
    ...
    $('.mobile-button, .close-nav-mobile').on('click', function () {
